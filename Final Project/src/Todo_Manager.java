    ...
    do {
      ...
      switch (choice) {
        ...
        case 2: {
          ...
          System.out.println("Enter number of task you wish to remove:");
          String task = in.nextLine();
          taskmap.remove(no_of_task, task);
          break;
        }
        case 3: {
          // update
          ...
          Integer no_of_task = Integer.valueOf(in.nextInt());
          System.out.println("Enter number of task you wish to update");
          String task = in.nextLine();
          taskmap.replace(no_of_task, task);
          break;
